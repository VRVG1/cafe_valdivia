...
@JsonKey(name: 'id_producto') int? get idProducto; String get nombre; String? get descripcion;@JsonKey(name: 'precio_venta') String get precioVenta;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,idProducto,nombre,descripcion,precioVenta);

@override
String toString() {
  return 'Producto(idProducto: $idProducto, nombre: $nombre, descripcion: $descripcion, precioVenta: $precioVenta)';
}
...
@useResult
$Res call({
@JsonKey(name: 'id_producto') int? idProducto, String nombre, String? descripcion,@JsonKey(name: 'precio_venta') String precioVenta
});
...
/// Create a copy of Producto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? idProducto = freezed,Object? nombre = null,Object? descripcion = freezed,Object? precioVenta = null,}) {
  return _then(_self.copyWith(
idProducto: freezed == idProducto ? _self.idProducto : idProducto // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'id_producto')  int? idProducto,  String nombre,  String? descripcion, @JsonKey(name: 'precio_venta')  String precioVenta)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Producto() when $default != null:
return $default(_that.idProducto,_that.nombre,_that.descripcion,_that.precioVenta);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'id_producto')  int? idProducto,  String nombre,  String? descripcion, @JsonKey(name: 'precio_venta')  String precioVenta)  $default,) {final _that = this;
switch (_that) {
case _Producto():
return $default(_that.idProducto,_that.nombre,_that.descripcion,_that.precioVenta);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'id_producto')  int? idProducto,  String nombre,  String? descripcion, @JsonKey(name: 'precio_venta')  String precioVenta)?  $default,) {final _that = this;
switch (_that) {
case _Producto() when $default != null:
return $default(_that.idProducto,_that.nombre,_that.descripcion,_that.precioVenta);case _:
  return null;
...
class _Producto implements Producto {
  const _Producto({@JsonKey(name: 'id_producto') this.idProducto, required this.nombre, this.descripcion, @JsonKey(name: 'precio_venta') required this.precioVenta});
...
/// Create a copy of Producto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? idProducto = freezed,Object? nombre = null,Object? descripcion = freezed,Object? precioVenta = null,}) {
