...
@JsonKey(name: 'id_proveedor') int? get id; String get nombre; String? get telefono; String? get email; String? get direccion;@IntToBoolConverter() bool get activo;@JsonKey(name: 'deleted_at') DateTime? get deletedAt;@JsonKey(name: 'updated_at') DateTime? get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,nombre,telefono,email,direccion,activo,deletedAt,updatedAt);

@override
String toString() {
  return 'Proveedor(id: $id, nombre: $nombre, telefono: $telefono, email: $email, direccion: $direccion, activo: $activo, deletedAt: $deletedAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
@JsonKey(name: 'id_proveedor') int? id, String nombre, String? telefono, String? email, String? direccion,@IntToBoolConverter() bool activo,@JsonKey(name: 'deleted_at') DateTime? deletedAt,@JsonKey(name: 'updated_at') DateTime? updatedAt
});
...
/// Create a copy of Proveedor
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? nombre = null,Object? telefono = freezed,Object? email = freezed,Object? direccion = freezed,Object? activo = null,Object? deletedAt = freezed,Object? updatedAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'id_proveedor')  int? id,  String nombre,  String? telefono,  String? email,  String? direccion, @IntToBoolConverter()  bool activo, @JsonKey(name: 'deleted_at')  DateTime? deletedAt, @JsonKey(name: 'updated_at')  DateTime? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Proveedor() when $default != null:
return $default(_that.id,_that.nombre,_that.telefono,_that.email,_that.direccion,_that.activo,_that.deletedAt,_that.updatedAt);case _:
  return orElse();
...
class _Proveedor implements Proveedor {
  const _Proveedor({@JsonKey(name: 'id_proveedor') this.id, required this.nombre, this.telefono, this.email, this.direccion, @IntToBoolConverter() this.activo = true, @JsonKey(name: 'deleted_at') this.deletedAt, @JsonKey(name: 'updated_at') this.updatedAt});
...
/// Create a copy of Proveedor
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? nombre = null,Object? telefono = freezed,Object? email = freezed,Object? direccion = freezed,Object? activo = null,Object? deletedAt = freezed,Object? updatedAt = freezed,}) {
