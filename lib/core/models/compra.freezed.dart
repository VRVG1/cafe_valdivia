...
@JsonKey(name: 'id_compra') int? get id;@JsonKey(name: 'id_proveedor') int get idProveedor; DateTime get fecha; String? get detalles;@BoolToIntConverter() bool? get pagado;@IntToBoolConverter() bool get activo;@JsonKey(name: 'deleted_at') DateTime? get deletedAt;@JsonKey(name: 'updated_at') DateTime? get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,idProveedor,fecha,detalles,pagado,activo,deletedAt,updatedAt);

@override
String toString() {
  return 'Compra(id: $id, idProveedor: $idProveedor, fecha: $fecha, detalles: $detalles, pagado: $pagado, activo: $activo, deletedAt: $deletedAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
@JsonKey(name: 'id_compra') int? id,@JsonKey(name: 'id_proveedor') int idProveedor, DateTime fecha, String? detalles,@BoolToIntConverter() bool? pagado,@IntToBoolConverter() bool activo,@JsonKey(name: 'deleted_at') DateTime? deletedAt,@JsonKey(name: 'updated_at') DateTime? updatedAt
});
...
/// Create a copy of Compra
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? idProveedor = null,Object? fecha = null,Object? detalles = freezed,Object? pagado = freezed,Object? activo = null,Object? deletedAt = freezed,Object? updatedAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'id_compra')  int? id, @JsonKey(name: 'id_proveedor')  int idProveedor,  DateTime fecha,  String? detalles, @BoolToIntConverter()  bool? pagado, @IntToBoolConverter()  bool activo, @JsonKey(name: 'deleted_at')  DateTime? deletedAt, @JsonKey(name: 'updated_at')  DateTime? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Compra() when $default != null:
return $default(_that.id,_that.idProveedor,_that.fecha,_that.detalles,_that.pagado,_that.activo,_that.deletedAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'id_compra')  int? id, @JsonKey(name: 'id_proveedor')  int idProveedor,  DateTime fecha,  String? detalles, @BoolToIntConverter()  bool? pagado, @IntToBoolConverter()  bool activo, @JsonKey(name: 'deleted_at')  DateTime? deletedAt, @JsonKey(name: 'updated_at')  DateTime? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _Compra():
return $default(_that.id,_that.idProveedor,_that.fecha,_that.detalles,_that.pagado,_that.activo,_that.deletedAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'id_compra')  int? id, @JsonKey(name: 'id_proveedor')  int idProveedor,  DateTime fecha,  String? detalles, @BoolToIntConverter()  bool? pagado, @IntToBoolConverter()  bool activo, @JsonKey(name: 'deleted_at')  DateTime? deletedAt, @JsonKey(name: 'updated_at')  DateTime? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _Compra() when $default != null:
return $default(_that.id,_that.idProveedor,_that.fecha,_that.detalles,_that.pagado,_that.activo,_that.deletedAt,_that.updatedAt);case _:
  return null;
...
class _Compra implements Compra {
  const _Compra({@JsonKey(name: 'id_compra') this.id, @JsonKey(name: 'id_proveedor') required this.idProveedor, required this.fecha, this.detalles, @BoolToIntConverter() this.pagado, @IntToBoolConverter() this.activo = true, @JsonKey(name: 'deleted_at') this.deletedAt, @JsonKey(name: 'updated_at') this.updatedAt});
  factory _Compra.fromJson(Map<String, dynamic> json) => _$CompraFromJson(json);

@override@JsonKey(name: 'id_compra') final  int? id;
...
/// Create a copy of Compra
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? idProveedor = null,Object? fecha = null,Object? detalles = freezed,Object? pagado = freezed,Object? activo = null,Object? deletedAt = freezed,Object? updatedAt = freezed,}) {
