...
@JsonKey(name: 'id_articulo') int? get id; String get nombre; String? get descripcion; ArticuloTipo get tipo;@JsonKey(name: 'id_unidad') int get idUnidad;@JsonKey(name: 'costo_unitario') double get costoUnitario;@JsonKey(name: 'precio_venta') double get precioVenta; double get stock;@IntToBoolConverter() bool get activo;@JsonKey(name: 'deleted_at') DateTime? get deletedAt;@JsonKey(name: 'updated_at') DateTime? get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,nombre,descripcion,tipo,idUnidad,costoUnitario,precioVenta,stock,activo,deletedAt,updatedAt);

@override
String toString() {
  return 'Articulo(id: $id, nombre: $nombre, descripcion: $descripcion, tipo: $tipo, idUnidad: $idUnidad, costoUnitario: $costoUnitario, precioVenta: $precioVenta, stock: $stock, activo: $activo, deletedAt: $deletedAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
@JsonKey(name: 'id_articulo') int? id, String nombre, String? descripcion, ArticuloTipo tipo,@JsonKey(name: 'id_unidad') int idUnidad,@JsonKey(name: 'costo_unitario') double costoUnitario,@JsonKey(name: 'precio_venta') double precioVenta, double stock,@IntToBoolConverter() bool activo,@JsonKey(name: 'deleted_at') DateTime? deletedAt,@JsonKey(name: 'updated_at') DateTime? updatedAt
});
...
/// Create a copy of Articulo
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? nombre = null,Object? descripcion = freezed,Object? tipo = null,Object? idUnidad = null,Object? costoUnitario = null,Object? precioVenta = null,Object? stock = null,Object? activo = null,Object? deletedAt = freezed,Object? updatedAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'id_articulo')  int? id,  String nombre,  String? descripcion,  ArticuloTipo tipo, @JsonKey(name: 'id_unidad')  int idUnidad, @JsonKey(name: 'costo_unitario')  double costoUnitario, @JsonKey(name: 'precio_venta')  double precioVenta,  double stock, @IntToBoolConverter()  bool activo, @JsonKey(name: 'deleted_at')  DateTime? deletedAt, @JsonKey(name: 'updated_at')  DateTime? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Articulo() when $default != null:
return $default(_that.id,_that.nombre,_that.descripcion,_that.tipo,_that.idUnidad,_that.costoUnitario,_that.precioVenta,_that.stock,_that.activo,_that.deletedAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'id_articulo')  int? id,  String nombre,  String? descripcion,  ArticuloTipo tipo, @JsonKey(name: 'id_unidad')  int idUnidad, @JsonKey(name: 'costo_unitario')  double costoUnitario, @JsonKey(name: 'precio_venta')  double precioVenta,  double stock, @IntToBoolConverter()  bool activo, @JsonKey(name: 'deleted_at')  DateTime? deletedAt, @JsonKey(name: 'updated_at')  DateTime? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _Articulo():
return $default(_that.id,_that.nombre,_that.descripcion,_that.tipo,_that.idUnidad,_that.costoUnitario,_that.precioVenta,_that.stock,_that.activo,_that.deletedAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'id_articulo')  int? id,  String nombre,  String? descripcion,  ArticuloTipo tipo, @JsonKey(name: 'id_unidad')  int idUnidad, @JsonKey(name: 'costo_unitario')  double costoUnitario, @JsonKey(name: 'precio_venta')  double precioVenta,  double stock, @IntToBoolConverter()  bool activo, @JsonKey(name: 'deleted_at')  DateTime? deletedAt, @JsonKey(name: 'updated_at')  DateTime? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _Articulo() when $default != null:
return $default(_that.id,_that.nombre,_that.descripcion,_that.tipo,_that.idUnidad,_that.costoUnitario,_that.precioVenta,_that.stock,_that.activo,_that.deletedAt,_that.updatedAt);case _:
  return null;
...
class _Articulo implements Articulo {
  const _Articulo({@JsonKey(name: 'id_articulo') this.id, required this.nombre, this.descripcion, required this.tipo, @JsonKey(name: 'id_unidad') required this.idUnidad, @JsonKey(name: 'costo_unitario') required this.costoUnitario, @JsonKey(name: 'precio_venta') required this.precioVenta, required this.stock, @IntToBoolConverter() this.activo = true, @JsonKey(name: 'deleted_at') this.deletedAt, @JsonKey(name: 'updated_at') this.updatedAt});
  factory _Articulo.fromJson(Map<String, dynamic> json) => _$ArticuloFromJson(json);

@override@JsonKey(name: 'id_articulo') final  int? id;
...
/// Create a copy of Articulo
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? nombre = null,Object? descripcion = freezed,Object? tipo = null,Object? idUnidad = null,Object? costoUnitario = null,Object? precioVenta = null,Object? stock = null,Object? activo = null,Object? deletedAt = freezed,Object? updatedAt = freezed,}) {
