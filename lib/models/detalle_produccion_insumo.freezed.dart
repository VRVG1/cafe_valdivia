...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,idDetalleProduccionInsumo,idOrdenProduccion,idInsumo,cantidadUsada,costoInsumoMomento);

@override
String toString() {
  return 'DetalleProduccionInsumo(idDetalleProduccionInsumo: $idDetalleProduccionInsumo, idOrdenProduccion: $idOrdenProduccion, idInsumo: $idInsumo, cantidadUsada: $cantidadUsada, costoInsumoMomento: $costoInsumoMomento)';
}
...
/// Create a copy of DetalleProduccionInsumo
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? idDetalleProduccionInsumo = freezed,Object? idOrdenProduccion = freezed,Object? idInsumo = null,Object? cantidadUsada = null,Object? costoInsumoMomento = null,}) {
...
class _DetalleProduccionInsumo implements DetalleProduccionInsumo {
  const _DetalleProduccionInsumo({@JsonKey(name: 'id_detalle_produccion') this.idDetalleProduccionInsumo, @JsonKey(name: 'id_orden_produccion') this.idOrdenProduccion, @JsonKey(name: 'id_insumo') required this.idInsumo, @JsonKey(name: 'cantidad_usada') required this.cantidadUsada, @JsonKey(name: 'costo_insumo_momento') required this.costoInsumoMomento});
...
/// Create a copy of DetalleProduccionInsumo
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? idDetalleProduccionInsumo = freezed,Object? idOrdenProduccion = freezed,Object? idInsumo = null,Object? cantidadUsada = null,Object? costoInsumoMomento = null,}) {
